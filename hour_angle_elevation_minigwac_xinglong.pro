pro Hour_angle_elevation_MINIGWAC_xinglong
close,/all
...
array = removerows(array,index_field_prority)
...
time_length_hour_str = (strtrim(strtrim(string(format='(f4.2)',$
...
close,120
device,/close_file
cgPS2Raster, outputfile + '.ps', /JPEG
cgPS2Raster, area_time_fig+'.ps', /JPEG
