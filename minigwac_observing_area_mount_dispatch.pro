pro minigwac_observing_area_mount_dispatch,inputfile,mount_inputfile,star_num_inputfile,sky_mosaic_inputfile,outputfile,outputfile3,mount_num,Julian,long,deta_local,timeBJ_start,timeBJ_end
...
;            print,'matched'
      ...
      for mnt = 1, y do begin
        ...
        array_tmp = removerows_new(array_tmp,m_obsed)
...
for z=0,n_elements(m_array[0,*])-1 do begin
  if float(m_array[0,z]) gt timeBJ_start and float(m_array[0,z]) lt timeBJ_end then begin
