pro minigwac_observing_area_total_night_web
close,/all
...
night_time[k] = utc_day + (k*5.0/60.0/24.0)
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 100 and zenith_solar_daily[k] lt 102 and timeBJ lt 24 then begin
...
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 102 then begin
timeBJ_start = timeBJ
timeBJ_hms=d2dms(timeBJ)
...
night_time[k] = utc_day + (k*10.0/60.0/24.0)
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 102 and zenith_solar_daily[k] lt 104 and timeBJ ge 24.0 then begin
timeBJ_end = timeBJ
timeBJ_hms=d2dms(timeBJ)
printf,110,timeBJ_hms,'  ',1
obse_mode = 1
...
minigwac_observing_area_mount_dispatch,inputfile,mount_inputfile,star_num_inputfile,sky_mosaic_inputfile,outputfile,outputfile3,mount_num,Julian,long,deta_local,timeBJ_start,timeBJ_end
...
night_time[k] = utc_day + (k*10.0/60.0/24.0)
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 100 and zenith_solar_daily[k] lt 102 and timeBJ gt 24 then begin
  timeBJ_hms=d2dms(timeBJ)
printf,110,timeBJ_hms,'  ',5
minigwac_observing_area_dark,k,mount_num,newyear,night_time[k],timeBJ
dark_expo = 1
...
night_time[k] = utc_day + (k*10.0/60.0/24.0)
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 98 and zenith_solar_daily[k] lt 100 and timeBJ gt 24 then begin
timeBJ_hms=d2dms(timeBJ)
printf,110,timeBJ_hms,'  ',3
minigwac_observing_area_park,k,mount_num,newyear,night_time[k],timeBJ
park = 1
endif
...
night_time[k] = utc_day + (k*10.0/60.0/24.0)
zenith_solar_daily[k] = zenith(night_time[k],lat,long)*180/3.1415926
if zenith_solar_daily[k] gt 96 and zenith_solar_daily[k] lt 98 and timeBJ gt 24 then begin
timeBJ_hms=d2dms(timeBJ)
...
minigwac_observing_area_living_data,outputfile1,outputfile4
