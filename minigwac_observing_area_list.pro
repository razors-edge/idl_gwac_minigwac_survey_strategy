pro minigwac_observing_area_list,inputfile,mount_inputfile,outputfile,outputfile1,mount_num,Julian,long,deta_local
...
2: printf,120,$
string(fix(array3[0]),fix(array3[1]),fix(array3[2]),format='(i02,":",i02,":",i02)'),$
array2[0],array2[1],' 1 ',array2[2],array2[3],' 1 '
3: printf,120,$
string(fix(array3[0]),fix(array3[1]),fix(array3[2]),format='(i02,":",i02,":",i02)'),$
array2[0],array2[1],' 1 ',array2[2],array2[3],' 1 ',array2[4],array2[5],' 1 '
4:printf,120,$
string(fix(array3[0]),fix(array3[1]),fix(array3[2]),format='(i02,":",i02,":",i02)'),$
array2[0],array2[1],' 1 ',array2[2],array2[3],' 1 ',array2[4],array2[5],' 1 ',array2[6],array2[7],' 1 '
5:printf,120,$
string(fix(array3[0]),fix(array3[1]),fix(array3[2]),format='(i02,":",i02,":",i02)'),$
array2[0],array2[1],' 1 ',array2[2],array2[3],' 1 ',array2[4],array2[5],' 1 ',$
array2[6],array2[7],' 1 ',array2[8],array2[9],' 1 '
6:printf,120,$
string(fix(array3[0]),fix(array3[1]),fix(array3[2]),format='(i02,":",i02,":",i02)'),$
array2[0],array2[1],' 1 ',array2[2],array2[3],' 1 ',array2[4],array2[5],' 1 ',$
array2[6],array2[7],' 1 ',array2[8],array2[9],' 1 ',array2[10],array2[11],' 1 '
endcase
